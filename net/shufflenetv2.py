...
class ShuffleNetV2(nn.Module):
    def __init__(self, num_classes=1000, input_size=224, width_mult=1.):
        ...
        if width_mult == 0.5:
            ...
            raise ValueError(
                "invalid width multiple value {}".format(width_mult))
...
def shufflenetv2_1x(num_classes=1000, **kwargs):
    model = ShuffleNetV2(num_classes=num_classes, width_mult=1., **kwargs)
    return model


def shufflenetv2_05x(num_classes=1000, **kwargs):
    model = ShuffleNetV2(num_classes=num_classes, width_mult=.5, **kwargs)
    return model
